...
Forecasted demand, no backorders.

Output: output_5a.xlsx
"""
...
def solve_5a():
    ...
    # Full objective: setup + holding + overtime + modernization
    ...
    if m.Status not in [GRB.OPTIMAL, GRB.SUBOPTIMAL]:
        print("No solution for 5a. Status: " + str(m.Status))
        return
    ...
    print_cost_summary("ASSIGNMENT 5A — Finite Capacity + Overtime + Modernization", df_cost)
    ...
    # Print JSON-style output matching expected format
    print("\n--- Output Summary ---")
    print({
    ...
    print("\n  Output written to output_5a.xlsx")
